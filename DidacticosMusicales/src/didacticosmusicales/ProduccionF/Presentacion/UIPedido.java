...
public class UIPedido extends javax.swing.JFrame {
    ...
    public UIPedido(ControladorPrincipal cp) {
        initComponents();
        controlador = cp;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String fechaEnvio = controlador.getMateriales().getProduccion().buscarPedido(id).getFechaEnvio().toString();
        String material = controlador.getMateriales().getProduccion().buscarPedido(id).getMaterialProveedor().getMaterial().getNombre();
        String proveedor = controlador.getMateriales().getProduccion().buscarPedido(id).getMaterialProveedor().getProveedor().getNombre();
        jTextField2.setText(fechaEnvio);
        jTextField3.setText(material);
        jTextField4.setText(proveedor);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        controlador.getPedidos().nuevoPedido(material, cantidad, proveedor);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        controlador.getPedidos().recibirPedido(id);
